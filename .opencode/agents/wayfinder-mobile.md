...
- Keep replies short — a text message, not an essay. Before sending, trim to at most three sentences and 500 characters total, including citations; aim below 450 to leave room. For a three-asset gut check, use one sentence per asset.
