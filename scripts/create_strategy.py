...
RISK_LIMITS_JSON = """{{
  ...
  "max_position_per_symbol_usd": 500.0,
  "max_daily_loss_usd": 50.0,
  "pause_after_consecutive_losses": 5,
  "_notes": {{
    "rationale": "Default conservative caps for a freshly scaffolded strategy. RECALIBRATE before deploying to live capital — these numbers are placeholders sized for ~$500 NAV. See backtest worst-case drawdown and your wallet NAV to set max_drawdown and max_daily_loss_usd correctly.",
    "scaffolder_origin": "{dir_name} (auto-generated by scripts/create_strategy.py)"
  }}
}}
"""
...
async def main():
    ...
    (strategy_dir / "risk_limits.json").write_text(RISK_LIMITS_JSON.format(**fmt))
