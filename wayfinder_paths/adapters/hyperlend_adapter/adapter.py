...
_reserve_to_dict = reserve_to_dict
_compute_supply_cap_headroom = compute_supply_cap_headroom
...
class HyperlendAdapter(BaseAdapter):
    ...
    def __init__(
        ...
        self.strategy_wallet_address = self._resolve_strategy_wallet_address(config)
