    ...
    *,
    ...
    task_line = (
        ...
        if evolution_enabled
            ...
            "aggregate by exit reason (`unrecorded` = closed before exit "
            "telemetry existed, `unlabeled` = the strategy gave no reason; "
            "neither says whether a stop fired). When forward trades show a pattern "
