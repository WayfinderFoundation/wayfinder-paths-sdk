...
async def shared_list_adapters() -> str:
    root = repo_root()
...
async def shared_list_strategies() -> str:
    root = repo_root()
...
async def shared_describe_adapter(name: str) -> str:
    root = repo_root()
...
async def shared_describe_strategy(name: str) -> str:
    root = repo_root()
