...
mcp.resource("wayfinder://delta-lab/{basis_symbol}/apy-sources/{limit}")(get_basis_apy_sources)
mcp.resource("wayfinder://delta-lab/{basis_symbol}/delta-neutral/{limit}")(get_best_delta_neutral_pairs)
