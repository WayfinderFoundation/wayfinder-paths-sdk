...
allowlist can use a single glob (`wayfinder_<namespace>_*: true`) to scope
a persona's surface. Namespaces:
...
mcp.tool()(onchain_get_wallet)
mcp.tool()(onchain_get_wallet_balances)
...
mcp.tool()(shared_list_adapters)
mcp.tool()(shared_list_strategies)
mcp.tool()(shared_describe_adapter)
mcp.tool()(shared_describe_strategy)
mcp.tool()(shared_wallets)
mcp.tool()(shared_execute)
mcp.tool()(shared_run_script)
mcp.tool()(shared_runner)
