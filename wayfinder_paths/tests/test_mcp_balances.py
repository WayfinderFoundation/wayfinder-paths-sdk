...
from wayfinder_paths.mcp.resources.wallets import onchain_get_wallet_balances
...
async def test_get_wallet_balances_filters_solana(mock_wallet):
    ...
    with (
        ...
        result = await onchain_get_wallet_balances("test")
...
async def test_get_wallet_balances_wallet_not_found():
    with patch(
        ...
        result = await onchain_get_wallet_balances("nonexistent")
